...
def classify_dealership_visit(transcript: str) -> tuple:
    ...
    # Option 5 – Correction: not an inventory sales conversation
    inventory_keywords = [
    ...
    definite_intent_phrases = [
        ...
        "coming over", "i’ll head over", "i’m visiting"
    ]
    ...
    # Option 1 – Yes, at a specific time + definite intent + visit
    ...
    # Option 3 – Visit discussed but no agreement (vague intent/time)
    if (
    ...
    # Option 4 – No new visit discussed (or refused)
